...
int minValue = ReadInt("Задайте минимальный числовой предел массива: ");
int maxValue = ReadInt("Задайте максимальный числовой предел массива: ");
double[] arr = RandomArray(length, minValue, maxValue);
PrintArray(arr);
BubbleSort(arr);
PrintArray(arr);
Console.WriteLine($"Разница между максимальным и минимальным элементами массива: {Difference(arr)}.");
